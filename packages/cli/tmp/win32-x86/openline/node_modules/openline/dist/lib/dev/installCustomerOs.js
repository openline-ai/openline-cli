...
exports.provisionPostgresql = exports.installCustomerOs = void 0;
...
function installCustomerOs(verbose, imageVersion = 'latest') {
    let result = false;
...
exports.installCustomerOs = installCustomerOs;
function getSetupFiles(verbose, imageVersion = 'latest') {
    let result = true;
...
function customerOsInstall(verbose, imageVersion = 'latest') {
    let result = true;
    let config = (0, dev_1.getConfig)();
...
function provisionNeo4j(verbose) {
    let result = true;
    let neo = '';
    let config = (0, dev_1.getConfig)();
    let retry = 1;
...
function provisionPostgresql(verbose) {
    let result = true;
